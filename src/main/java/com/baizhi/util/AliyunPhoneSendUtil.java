...
public class AliyunPhoneSendUtil {
    ...
    private static SendSmsResponse getsendPhoneCodes(String phoneNumbers, String signName, String templateCode, String templateParam) throws ClientException {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4FyfQ5vDESMMNyzjNBrg";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "AuBZwzbi1UWXDc7dI9tu7BPa8w8pWi";//你的accessKeySecret，参考本文档步骤2
    ...
    //发送短信验证码
    public static String sendPhoneCode(String phones, String code) {

        String phoneNumbers = phones;
        String signName = "新丽洗浴";
        String templateCode = "SMS_195575792";
